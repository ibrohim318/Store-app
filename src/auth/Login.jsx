...
function Login() {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="w-full cursor-pointer bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium py-2.5 rounded-lg mt-2 transition-colors">Kirish</button>
        </form>
    )
}
